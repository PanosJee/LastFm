...
Gem::Specification.new do |s|
  ...
  s.files = ["MIT-LICENSE", "Manifest", "README.textile", "Rakefile", "lastfm.gemspec", "lib/last_fm.rb", "lib/last_fm/models/album.rb", "lib/last_fm/models/artist.rb", "lib/last_fm/models/base.rb", "lib/last_fm/models/chart.rb", "lib/last_fm/models/event.rb", "lib/last_fm/models/tag.rb", "lib/last_fm/models/track.rb", "lib/last_fm/models/user.rb"]
